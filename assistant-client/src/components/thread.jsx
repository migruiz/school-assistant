...
export const Thread = () => {
  return (
    <ThreadPrimitive.Root
      className="bg-background flex h-full flex-col @container"
      style={{
...
const ThreadWelcome = () => {
  return (
    <ThreadPrimitive.Empty>
      <div
        className="mx-auto flex w-full max-w-[var(--thread-max-width)] flex-grow flex-col px-[var(--thread-padding-x)]">
...
const Composer = () => {
  return (
    <div
      className="bg-background relative mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col gap-4 px-[var(--thread-padding-x)] pb-4 md:pb-6">
      <ThreadScrollToBottom />
      <ThreadPrimitive.Empty>
        <ThreadWelcomeSuggestions />
      </ThreadPrimitive.Empty>
      <ComposerPrimitive.Root
        className="relative flex w-full flex-col rounded-2xl focus-within:ring-2 focus-within:ring-black focus-within:ring-offset-2 dark:focus-within:ring-white">
...
const ComposerAction = () => {
  return (
    <div
      className="bg-muted border-border dark:border-muted-foreground/15 relative flex items-center justify-between rounded-b-2xl border-x border-b p-2">
      <TooltipIconButton
        tooltip="Attach file"
        variant="ghost"
...
const MessageError = () => {
  return (
    <MessagePrimitive.Error>
      <ErrorPrimitive.Root
        className="border-destructive bg-destructive/10 dark:bg-destructive/5 text-destructive mt-2 rounded-md border p-3 text-sm dark:text-red-200">
  ...
  return (
    <MessagePrimitive.Root asChild>
      <motion.div
        ...
        <div
          className="text-foreground col-span-2 col-start-2 row-start-1 ml-4 break-words leading-7">
  ...
  return (
    <MessagePrimitive.Root asChild>
      <motion.div
        ...
        <div
          className="bg-muted text-foreground col-start-2 break-words rounded-3xl px-5 py-2.5">
...
const EditComposer = () => {
  return (
    <div
      className="mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col gap-4 px-[var(--thread-padding-x)]">
